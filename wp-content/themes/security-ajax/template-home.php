...
?>
	<section class="product-description indent-top-small indent-bottom-small animation-tracking">
	  <div class="container">
        ...
        <div class="pic-wrapper col-lg-6 col-sm-8 col-10 offset-1 offset-sm-2 offset-lg-0">
          <img
             class="lazy"
...
<?php
  $whatIsBlTitle = carbon_get_post_meta( get_the_ID(), 'security_product_what_is_block_title'.security_lang_prefix());
	...
	$whatIsBlDeviceMob = carbon_get_post_meta( get_the_ID(), 'security_product_what_is_mob_image'.security_lang_prefix());
    ...
    <div class="container">
      ...
      <div class="row second-up">
        <div class="content col-12">
          ...
          <div class="mobile-device-pic">
            <img
                class="lazy"
                data-src="<?php echo wp_get_attachment_image_src($whatIsBlDeviceMob, 'full')[0];?>"
                alt="<?php echo get_post_meta($whatIsBlDeviceMob, '_wp_attachment_image_alt', TRUE);?>"
            >
          </div>
